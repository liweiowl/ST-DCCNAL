...
def dense_conv3D(nb_filter=64, nb_row=3, nb_col=3, padding='same', bn=False, nb_layers=3):
    ...
    def f2(input):
        ...
        for fea in cnn_fea:
            ...
            tmp3 = Dense(units=1024, activation='tanh', kernel_regularizer=myreg)(tmp2)
...
def add_lstm(nb_flow=2, map_height=16, map_width=8):
    ...
    def f3(data_in):
        ...
        # main_output2 = LSTM(units=nb_flow * map_height * map_width, kernel_regularizer=myreg)(main_output1)
